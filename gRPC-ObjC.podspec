...
Pod::Spec.new do |s|
  ...
  s.subspec 'Interface-Legacy' do |ss|
    ss.header_mappings_dir = 'src/GRPCClient'

    ss.public_header_files = "src/GRPCClient/GRPCCall+ChannelArg.h",
    ...
    ss.source_files = "src/GRPCClient/GRPCCall+ChannelArg.h",
                      "src/GRPCClient/GRPCCall+ChannelCredentials.h",
                      "src/GRPCClient/GRPCCall+Cronet.h",
                      "src/GRPCClient/GRPCCall+OAuth2.h",
                      "src/GRPCClient/GRPCCall+Tests.h",
    ...
    ss.dependency "gRPC-ObjC-RxLibrary/Interface", version
  ...
  s.subspec 'Interface' do |ss|
    ...
    ss.public_header_files = 'src/GRPCClient/GRPCCall.h',
    ...
    ss.source_files = 'src/GRPCClient/GRPCCall.h',
  ...
  s.subspec 'GRPCCore' do |ss|
    ...
    ss.public_header_files = 'src/GRPCClient/GRPCCall+ChannelCredentials.h',
                             'src/GRPCClient/GRPCCall+Cronet.h',
                             'src/GRPCClient/GRPCCall+OAuth2.h',
                             'src/GRPCClient/GRPCCall+Tests.h',
                             'src/GRPCClient/GRPCCall+ChannelArg.h'
    ss.private_header_files = 'src/GRPCClient/private/GRPCCore/*.h'
    ss.source_files = 'src/GRPCClient/private/GRPCCore/*.{h,m}',
                      'src/GRPCClient/GRPCCall+ChannelArg.h',
  ...
  s.subspec 'GRPCCoreCronet' do |ss|
    ...
    ss.source_files = 'src/GRPCClient/GRPCCall+Cronet.h',
                      'src/GRPCClient/GRPCCall+Cronet.m',
                      'src/GRPCClient/private/GRPCCore/GRPCCoreCronet/*.{h,m}'
    ss.dependency "#{s.name}/GRPCCore", version
    ss.dependency 'gRPC-Core/Cronet-Implementation', grpc_version
  ...
  s.subspec 'InternalTesting' do |ss|
    ss.dependency "#{s.name}/GRPCCore", version
    ss.public_header_files = 'src/GRPCClient/internal_testing/*.h'
    ss.source_files = 'src/GRPCClient/internal_testing/*.{h,m}'
    ss.header_mappings_dir = 'src/GRPCClient'
